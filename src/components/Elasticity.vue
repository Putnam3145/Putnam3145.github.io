<template>
    <div class = "tab_content">
        ...
        <b-input-group>
            ...
            <template #append>
                <b-button variant="info" v-b-toggle.bulk-help>K</b-button>
            </template>
        ...
        <template #append>
            <b-button variant="info" v-b-toggle.young-help>E</b-button>
        </template>
        ...
        <b-collapse accordion="elasticity-accord" id="young-help">
            <elasticity-info name="Young's modulus" href = "https://en.wikipedia.org/wiki/Young%27s_modulus">
                <template #dwarf>
        ...
        <b-input-group>
            ...
            <template #append>
                <b-button variant="info" v-b-toggle.shear-help>G</b-button>
            </template>
            </b-input-group>
        <b-collapse accordion="elasticity-accord" id="shear-help">
            <elasticity-info name="Shear modulus" href = "https://en.wikipedia.org/wiki/Shear_modulus">
                <template #dwarf>
        ...
        <div v-if="realisticElasticity">
            ...
            <elasticity-info name="Lamé's first parameter" href = "https://en.wikipedia.org/wiki/Lam%C3%A9_parameters">
                <template #dwarf>
                    Not used.
                </template>
                <template #science>
                    Lamé's first parameter, or λ, is one of the parameters relating stress to strain in materials in 3D space. This is, of course, true of <b>all</b> of the parameters in this tab, but Lamé's is interesting for being a lot more difficult to describe its physical consequences. Obviously it has some; one can describe all of an isomorphic homogenous material's elastic properties using nothing but λ and any of these other ones. <a href=https://agilescientific.com/blog/2012/9/26/l-is-for-lambda.html>Here's a post on it, I guess.</a> It's mostly here for convenience sake: there is a small chance a material will have only λ and one other parameter. This is also why we add Poisson's ratio, below.
                </template>
            </elasticity-info>
            </b-collapse>
            <b-input-group>
...
import ElasticityInfo from "@/components/ElasticityInfo.vue"
